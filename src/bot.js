...
export class Bot {
  ...
  async processNotification(notif) {
    ...
    const videoIntentSystemPrompt = `
      ...
      Your answer must be ONLY the word "yes" or "no". Do NOT include any other text, reasoning, or "I can't see images" refusals.
    `.trim();
    ...
    const contextIntentSystemPrompt = `You are an intent detection AI. Analyze the user's post to determine if they are asking a question that requires their own profile or post history as context. This includes questions like "give me recommendations", "summarize my profile", "what do you think of me?", etc. Your answer must be ONLY the word "yes" or "no". Do NOT include any other text, reasoning, <think> tags, or "I can't see images" refusals.`;
    ...
    const repoIntentPrompt = `Analyze the user's post to determine if they are asking about the bot's code, architecture, tools, or internal logic. Respond with ONLY the word "yes" or "no". Do NOT include any other text, reasoning, <think> tags, or "I can't see images" refusals.\n\nUser's post: "${text}"`;
